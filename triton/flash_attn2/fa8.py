...
# Triton kernel: Flash Attention fwd v8
# 优化点：block pointer + 对齐提示 + multiple_of。
_configs = [
...
def _flash_fwd_kernel_v8(
    ...
    tl.multiple_of(start_m * BLOCK_M, BLOCK_M)
